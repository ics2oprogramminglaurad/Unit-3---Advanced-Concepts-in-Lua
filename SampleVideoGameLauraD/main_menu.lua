...
-- instructions screen transition 
local function InstructionsScreenTransition()
    composer.gotoScene("instructionsScreen", {effect = "zoomInOutFade", time = 1000})
end
...
function scene:create( event )
    ...
    -- creating instructions screen transition


    -- make the instrcution screen
    display.newImageRect("Images/Instructions Screen.png", display.contentWidth, display.contentHeight)
